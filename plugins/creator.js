...
Asena.addCommand({pattern: 'git', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `*👨‍🎤creater 🧞‍♂️Shefiq🧞‍♂️*
*owner number wa.me/919526128516*

*githublink     🧚‍♂️ https://github.com/Shefiqshaa/Black-panther-* 🧚‍♂️
